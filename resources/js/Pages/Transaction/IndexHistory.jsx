                                ...
                                <thead className="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400 border-b-2 border-gray-500">
                                        <tr className="text-nowrap">
                                            ...
                                            <TextInput
                                                ...
                                                placeholder="Data Od"
                                                type="date"
                                                onBlur={(e) => searchFieldChanged("dateFrom", e.target.value)}
                                                onKeyPress={(e) => onKeyPress("dateFrom", e)}
                                            />
                                                Data od
                                            <TextInput
                                                className="mx-auto p-2 rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 dark:focus:border-indigo-600 dark:focus:ring-indigo-600"
                                                ...
                                                placeholder="Data Do"
                                                type="date"
                                                onBlur={(e) => searchFieldChanged("dateTo", e.target.value)}
                                                onKeyPress={(e) => onKeyPress("dateTo", e)}
                                            />
                                                Data do
                                            </div>
                                            </th>
